...
# Stage 04 - Define context
Here the user should cover the context necessary for the prompt. Read additional context here: references/std-prompt-framework-context.md
...
# Stage goal
Learn which context the AI need in order to execute well. Give examples to illustrate what is being asked.
...
Proceed with executing stages/05-define-constraints/CONTEXT.md
